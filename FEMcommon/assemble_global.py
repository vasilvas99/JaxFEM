...
def assemble_global_matrix(mesh: mload.Mesh, local_matrix):
    ...
    global_mtx = rust_toolkit.assemble_global_matrix(
        onp.array(global_mtx, dtype=onp.double),
...
def assemble_global_vector(mesh: mload.Mesh, local_vector):
    ...
    global_vector = rust_toolkit.assemble_global_vector(
        onp.array(global_vector, dtype=onp.double),
